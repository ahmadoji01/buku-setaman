...
import { mockUsers, mockStories, mockModules } from "@/lib/mock-data"
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 text-sm text-muted-foreground">
                        <span>Dibuat: {module.createdAt.toLocaleDateString("id-ID")}</span>
                        <span>Diperbarui: {module.updatedAt.toLocaleDateString("id-ID")}</span>
                      </div>
                    </div>
